    ...
    <>
      <div id={id} className="pt-[5rem] sm:pt-[6rem]">
        <div className="relative ">
          <div className={`w-full relative h-[25rem] md:h-[36rem]  xl:h-[40rem] bg-black ${backgroundImageMobile ? "md:block hidden" : ""}`}>
            <Image
              fill
              src={getImageUrl(backgroundImageDesktop)}
              alt=" Banner Image"
          ...
          {backgroundImageMobile && (
            <div className="md:hidden block h-[30rem] relative w-full">
              <Image
                src={getImageUrl(backgroundImageMobile)}
                fill
          ...
          <div className="w-container overflow-hidden">
            <div className="absolute w-auto sm:w-auto top-9  sm:top-12 md:top-18 flex flex-col  justify-between h-[88%] sm:h-[80%]">
              ...
              <div className="  w-full ">
                <h1 className="text-white font-medium ">{heading}</h1>
