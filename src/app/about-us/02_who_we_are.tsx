...
export const metadata: Metadata = {
  ...
  description:'We are a think tank led by thought leaders & experts from the infrastructure domain. Together, we are elevating India’s infrastructural & economic trajectory. ',
  keywords: ['think tank india','think tanks','the infravision foundation','infravision foundation','policy research','public policy','about-us'],
  icons: {
    icon: [
