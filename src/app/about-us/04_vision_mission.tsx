        ...
        <div>
          ...
          <div className="pt-4 pb-2 md:py-5 flex flex-col md:flex-row justify-between gap-4">
            <h1 className="leading-snug font-light text-2xl md:text-3xl xl:text-5xl">
              To champion appropriate infrastructural <br /> development
              initiatives for economic prosperity.
            </h1>
          </div>
        </div>
          ...
          <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3 ">
            {data.map((elem, idx) => {
              return (
                <div
                  key={idx}
                  className="bg-[#FFFFFFB2] backdrop-blur-[10px] shadow-blur w-container py-10 rounded-md px-6"
                >
                  ...
                  <h5 className="blade-top-margin text-sm xl:text-lg">
                    {elem.desc}
                  </h5>
                </div>
              );
