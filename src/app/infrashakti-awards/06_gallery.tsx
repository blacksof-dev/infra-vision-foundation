...
import { parentGallery } from "../infrapandit-awards/05_gallery";
...
export default function Gallery() {
  ...
  const { data } = useQuery({
    queryKey: ["infrashakti-gallery"],
    queryFn: () =>
      getFetch<parentGallery>(
        "/gallery?page=1&limit=1000&event=InfraShakti%20Awards&activeOnMain=true",
      ),
  });
