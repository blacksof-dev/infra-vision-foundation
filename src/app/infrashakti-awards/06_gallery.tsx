...
const galleryImages = [
  ...
  },
  {
    ...
    description:
      "Rural Infra Pioneer Shashank Kumar from DeHaat at the ceremony.",
  },
  {
    image: "assets/infraShakti/gallery/image8.png",
    description:
      "Mr Vishnu Som, journalist and news anchor; Mr Anup Sahay, Head Corporate Strategy and Special Initiatives, L&T; Ms Rumjhum Chatterjee, Co-Founder & Managing Trustee, The Infravision Foundation; Mr Mallanna Sasalu, CEO, Provident Housing Ltd; with Mr Ashwani Gupta, CEO, Adani Ports and Special Economic Zone Limited.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Mr Pranav Adani, Managing Director (Agro, Oil & Gas) and Director of Adani Enterprises, delivering his keynote speech.",
  },
  {
    image: "assets/infraShakti/gallery/image10.png",
    description:
      "Mr Arman Ali, Executive Director, National Centre for Promotion of Employment for Disabled People (NCPEDP), and Mr Tarun Garg, COO, Hyundai Motor India, presenting the Inclusive Infrastructure Award to Ms Swarnalatha J, Managing Trustee, and Dr Guruprasad T S, Trustee of Swarga Foundation.",
  },
  {
    image: "assets/infraShakti/gallery/image3.png",
    description:
      "Mr Vinayak Chatterjee in discussion with Former NDTV Editor-in-Chief Mr Sanjay Pugalia.",
  },
  {
    image: "assets/infraShakti/gallery/image5.png",
    description:
      "Water Saviour Mr Arun Krishnamurthy from EFI with his award at the ceremony.",
  },
  {
    image: "assets/infraShakti/gallery/image12.png",
    description:
      "Jurors Mr Dilip Cherian, Image Guru and Policy Analyst with Prof G Raghuram, Former Director, IIMB and Dean, IIMA.",
  },
  {
    image: "assets/infraShakti/gallery/image4.png",
    description:
      "Urban Infra Hero Mr Sandeep Patel from NEPRA Resource Management Pvt Ltd at the ceremony.",
  },
  {
    image: "assets/infraShakti/gallery/image11.png",
    description:
      "Mr Mallanna Sasalu, CEO of Provident Housing Ltd, along with other attendees at the ceremony.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Former NDTV Editor-in-Chief Mr Sanjay Pugalia with three-time Grammy Award winner and  Padma Shri awardee Mr Ricky Kej.",
  },
  {
    image: "assets/infraShakti/gallery/image14.png",
    description:
      "Former NDTV Editor-in-Chief Mr Sanjay Pugalia in conversations with Hon'ble Union Minister Mr Nitin Gadkari.",
  },
  {
    image: "assets/infraShakti/gallery/image15.png",
    description:
      "Hon'ble Union Minister Mr Hardeep Singh Puri presenting the Renewable Energy Star Award to Mr Pankaj Kumar and Mr Siddhant Agarwal from Quant Solar.",
  },
];
