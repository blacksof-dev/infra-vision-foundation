          ...
          return (
            <div key={index} className=" max-w-sm relative h-[28rem]  w-full">
              <Image
                ...
                quality={100}
              />
              <div className="absolute  group top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <button
                  onClick={() => {
                    setActiveVideoSrc(ele.link);
                    setpopup(true);
                  }}
                  className="w-12 h-12 rounded-full ring-1 ring-pink bg-white flex items-center justify-center group-hover:bg-pink transition-all duration-100"
                >
