              ...
              {OberviewDetails.map((elem, index) => (
                <SwiperSlide key={index} className="">
                  <div className="relative h-[23rem] w-full rounded overflow-hidden shadow-md">
                    ...
                    <div className="absolute bottom-2 left-2 z-40  bg-white rounded-xl p-4 pr-20 w-[85%] max-w-[32rem]  h-[11rem]">
                      ...
                      <div className="absolute -top-6 -right-3 translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-white rounded-md flex items-center justify-center">
                        <Image
                          src={elem.logo}
                          alt={`${elem.title} logo`}
