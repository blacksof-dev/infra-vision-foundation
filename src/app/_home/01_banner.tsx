    ...
    <>
      <section className="">
        <div className="relative  overflow-hidden ">
          <div className="sm:block hidden h-[36rem] xl:h-full">
              <Image src={BannerBg} alt="InfraVison Fondation" className="h-full" />
          </div>
          <div className="sm:hidden block h-[38rem]">
              <Image src={mobileBannerBg} alt="InfraVison Fondation" className="h-full" />
          </div>
          ...
          <div className="absolute  top-[21%]  lg:top-[19%]  xl:top-[23%] 2xl:top-[20%] left-4  sm:left-9  md:left-[10%]  2xl:left-[7%] ">
            <div className="w-[80%] lg:w-full">
              <h1 className="tracking-[-4%] font-light txt-black/90">
                ...
                <br  className=""/> for infrastructure and <br className="xl:block hidden"/>
                nation-building{" "}
              </h1>
            </div>
