...
export default function PopupDescription({
  ...
  return (
    <>
      <Portal>
        <div className="fixed inset-0 flex overflow-auto  xl:items-center xl:justify-center bg-darkgray/30 z-[999]">
          <div className="bg-white rounded-lg w-full h-auto lg:h-[44rem]  max-w-screen-2xl relative md:m-4 m-2">
            <button
              onClick={onclose}
            ...
            <div className="flex flex-col lg:flex-row gap-4 md:gap-8 p-3 md:p-6 h-full overflow-hidden">
              {/* IMAGE SECTION */}
              <div className="relative w-full h-[25rem] sm:w-[25rem] sm:h-[25rem]  lg:w-[40%] lg:h-full">
                <Image
                  src={data.popupImg}
                  alt={data.title}
                  fill
                  ...
                  <p
                    className={`${
                      showlineclamp
                        ...
                        : "line-clamp-6"
                    } text-black lg:overflow-y-auto h-full  pr-2`}
