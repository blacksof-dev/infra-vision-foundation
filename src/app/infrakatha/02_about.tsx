...
export default function About() {
    return (
        <section className="relative blade-top-padding-lg blade-bottom-padding-lg bg-whitesmoke">
            <Image className='absolute top-0 right-0 sm:block hidden' src={bg} alt="background circle"></Image>
            <div className="w-container flex flex-col xl:flex-row gap-y-10 ">
                {/* Left: Text Content */}
                <div className="flex flex-col 2xl:justify-center ">
                    ...
                    <h1 className="text-black font-light">
                        ...
                        that spark <span className="font-medium">change</span><br />
                        <span className="font-medium">and awareness</span>
                    </h1>
                    <h5 className="text-black  mt-4 md:mt-6 md:max-w-xl xl:pr-10">
                        InfraKatha is a key initiative of The Infravision Foundation dedicated to familiarising and uplifting infrastructural discourse for meaningful outcomes.

                    </h5>
                    <h6 className="text-darkgray  mt-2 md:max-w-xl xl:pr-10">
                    ...
                    <div className='mt-6'>
                        <a href="#" className="inline-flex text-lg items-center gap-2 text-black font-medium group hover:underline hover:text-pink">
                            Watch the videos
                ...
                <div className="flex flex-col justify-end">
                    <div className='lg:border-l border-l-gray lg:pl-10'>
                        <h6 className="text-pink font-medium mb-4">The hosts</h6>
                        <div className="flex flex-wrap justify-center md:justify-start xl:grid grid-cols-2 2xl:grid-cols-3 gap-4 relative ">
                            <MemberCard
                                image={image_01}
                                title="Dilip Cherian"
