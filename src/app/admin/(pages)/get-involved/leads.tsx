    ...
    <section className="blade-top-margin">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 mt-6 bg-white border border-gray/30 p-4 rounded-md">
        <div className="flex items-center gap-3">
          <button
            ...
            className={`px-6 py-2 text-sm font-medium transition-all duration-300 rounded-md border ${
              filter === "unread"
        ...
        <div className="flex items-center gap-3">
          <span className="text-xs font-semibold text-darkgray/60 uppercase tracking-wider">
            Sort by:
          </span>
          <div className="relative">
            <select
              className="appearance-none border border-gray/30 rounded-md p-2 pr-10 text-sm bg-white focus:outline-none focus:ring-1 focus:ring-pink/50 transition-all font-medium text-darkgray min-w-[150px] cursor-pointer"
              value={sortOrder}
            ...
            <ChevronDown
              size={16}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-darkgray/40 pointer-events-none"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray/30 rounded-md overflow-hidden">
        <div className="bg-gray/30 h-12 grid grid-cols-[1.5fr_1.5fr_1fr_0.5fr] px-6 font-semibold text-darkgray text-sm">
          <div className="content-center text-xs uppercase tracking-wider">
            Name
          </div>
          <div className="content-center text-xs uppercase tracking-wider">
            Email
          </div>
          <div className="content-center text-center text-xs uppercase tracking-wider">
            Type
          </div>
          <div className="content-center text-right text-xs uppercase tracking-wider pr-4">
            Action
          </div>
        </div>
        <div className="divide-y divide-gray/20">
          {leads.map((lead) => (
            <div
              key={lead.id}
              className={`px-6 h-14 grid grid-cols-[1.5fr_1.5fr_1fr_0.5fr] cursor-pointer transition-all duration-200 hover:bg-gray/10 items-center ${
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span
                  className={`text-sm ${!lead.isRead ? "font-semibold" : "text-darkgray"}`}
                >
                  {lead.firstName} {lead.lastName}
                </span>
              </div>
              <div className="text-darkgray text-sm truncate pr-4">
                {lead.email}
              </div>
      ...
      <div className="mt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm px-2">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center">
            <label className="mr-2 text-xs font-semibold uppercase tracking-wider text-darkgray/60">
              Page size:
            </label>
            <div className="relative">
              <select
                className="appearance-none border border-gray/30 rounded pl-2 pr-8 py-1.5 text-sm bg-white cursor-pointer"
              ...
              <ChevronDown
                size={14}
                className="absolute right-2 top-1/2 -translate-y-1/2 text-darkgray/40 pointer-events-none"
              />
            </div>
          </div>
            ...
            <div className="flex-1 overflow-auto p-6 bg-white">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-5">
                  <h3 className="text-[10px] font-bold uppercase tracking-[0.1em] text-darkgray/40 border-b border-gray/20 pb-2">
                    Contact Information
                  </h3>
                  <div className="space-y-4">
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-[10px] font-bold text-darkgray/40 uppercase tracking-tight mb-0.5">
                          Email Address
                        </p>
              ...
              {/* Message Section */}
              <div className="mt-8">
                <h3 className="text-[10px] font-bold uppercase tracking-[0.1em] text-darkgray/40 border-b border-gray/20 pb-2 mb-4">
                  Message
                </h3>
