...
const Jury = () => {
  const data = [
...

    {
      ...
      position:
        "Group Chief Economic Advisor, SBI; Member, PM’s Economic Advisory Council, and Distinguished Fellow, The Infravision Foundation",
    },

    {
      ...
      position:
        "Chairman, BCG India Practice and Member, Council of Advisors at The Infravision Foundation",
    },
  ];
