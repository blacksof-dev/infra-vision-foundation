...
const formSchema = z.object({
  ...
  interest: z
    .string()
    .min(2, { message: "Select any Option" }),
...
export default function ContactForm() {
 ...
 return(
  <div role="status">
    <svg aria-hidden="true" className="w-8 h-8 text-gray-200 animate-spin dark:text-darkgray fill-lightgray" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
